...
const KEYWORDS: Record<CodeLanguage, string[]> = {
  rust: [
    ...
    "return","use","mod","pub","struct","enum","trait","impl","self","Self",
    "as","in","move","ref","where","async","await","dyn","true","false",
    "crate","super","break","continue","type",
  ],
  typescript: [
    "const","let","var","function","return","if","else","for","while","import",
    "from","export","default","class","interface","type","extends","implements",
    "new","this","async","await","true","false","null","undefined","as","of","in","void",
  ],
  java: ["public","private","protected","class","interface","static","final","void","new","return","if","else","for","while","import","package","extends","implements","true","false","null","this","super","try","catch","finally","throw","throws"],
  kotlin: ["fun","val","var","class","interface","object","if","else","when","for","while","return","import","package","true","false","null","this","super","private","public","internal","protected","suspend","override","data","sealed"],
  python: ["def","class","if","elif","else","for","while","return","import","from","as","with","try","except","finally","raise","True","False","None","and","or","not","in","is","lambda","yield","async","await","pass","break","continue","global","nonlocal"],
  bash: ["if","then","else","fi","for","in","do","done","while","case","esac","function","return","export","local","cd","echo","exit"],
  toml: [],
  text: [],
};
  ...
  return (
    <div className="my-6 overflow-hidden rounded-lg border border-border bg-surface-2">
      ...
      <pre className="overflow-x-auto p-4 text-[13px] leading-relaxed">
        <code
          className="text-mono text-foreground/90"
