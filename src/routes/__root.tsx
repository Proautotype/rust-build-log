  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <div className="text-mono text-xs uppercase tracking-widest text-primary">Error 404</div>
        <h1 className="mt-3 text-6xl font-display tracking-tight text-foreground">Not found</h1>
        <p className="mt-4 text-sm text-muted-foreground">
          This route doesn't compile. The page you're looking for was moved or never existed.
        </p>
        <div className="mt-6">
          <Link
            to="/"
